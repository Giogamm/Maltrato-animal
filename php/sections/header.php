    ...
    <nav class="navbar">
        <div class="container">
            <ul class="nav-menu">
                ...
                <li><a href="Registrarse.php" class="<?= basename($_SERVER['PHP_SELF']) == 'registrarse.php' ? 'activa': '' ?>">Registrarse o iniciar sesión</a></li>
                <li><a href="tablas.php" class="<?= basename($_SERVER['PHP_SELF']) == 'tablas.php' ? 'activa': '' ?>">Tablas-test</a></li>
            </ul>
        </div>
    </nav>
    <div class="empuje"> 
